...
public class Definitions {
    public static String title = "JDAC";
    public static int serialSpeed = 115200;
    public static final int exportPNGwidth = 1920;
    public static final int exportPNGheight = 1080;
}
